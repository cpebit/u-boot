...
#define CONFIG_BOOTCOMMAND \
    ...
    "setenv bootargs \"${bootargs} rk_dma_heap_cma=16M ubi.mtd=rootfs${bootpart} ubi.mtd=userdata ubi.block=0,rootfs${bootpart} root=/dev/ubiblock0_0 rootfstype=squashfs\"; " \
    "boot_fit;"
#endif
